...
def GlobalAlignment (string1, string2,sigma=5):
	...
	s[0,0]=0
	backtrack[0,0]=0
	# initiate values of border as decreasing of -5
	for i in range (1,n+1):
		s[i,0]=s[i-1,0]-sigma
		backtrack[i,0]=1 #right
	for j in range (1,m+1):
		s[0,j]=s[0,j-1]-sigma
		backtrack[0,j]=2 #down
	for i in range (1,n+1):
		for j in range (1,m+1):
			right=s[i-1,j]-sigma
			down=s[i,j-1]-sigma
			match=s[i-1,j-1]+blosum[string1[i-1]][string2[j-1]]
...
if __name__ == "__main__":
	string1='PLEASANTLY'
	string2='MEANLY'
	#file=open("dataset_247_3.txt").readlines()
	#lines=[line.rstrip() for line in file]
	#string1=lines[0]
	#string2=lines[1]
	maxscore,backtrack=GlobalAlignment(string1,string2,sigma=5)
